    ...
    <div class="container">
      ...
      <div class="row">
        <div class="section-header">
          <h2 class="wow fadeInDown animated"> Husband And Wife Rias Style</h2>
          <h3 class="wow fadeInDown animated">
            photographs of Husband And Wife Rias makeup</h3>
        </div>
          ...
          <div id="content20" data-section="content-20" class="data-section">
            <div class="col-sm-12 col-md-3">
              ...
              <div class="align-center"> <br>
                <a href="gambar/<?php echo $data['gambar']; ?>" class="work-box"> <img src="gambar/<?php echo $data['gambar']; ?>" width="280" height="230" />
